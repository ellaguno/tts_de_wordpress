...
class StorageException extends TTSException {
	...
	public static function uploadFailed(
		...
		$message = sprintf(
			/* translators: %1$s: filename, %2$s: storage provider name */
	...
	public static function deleteFailed(
		...
		$message = sprintf(
			/* translators: %1$s: file URL, %2$s: storage provider name */
	...
	public static function fileTooLarge(
		...
		$message = sprintf(
			/* translators: %1$s: filename, %2$s: file size, %3$s: storage provider name, %4$s: maximum file size */
	...
	public static function networkError(
		...
		$message = sprintf(
			/* translators: %1$s: operation name, %2$s: storage provider name */
